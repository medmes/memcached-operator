...
import (
	...
	cachev1alpha1 "github.com/medmes/memcached-operator/api/v1alpha1"
)

const memcachedFinalizer = "cache.homelab.io/finalizer"
...
//+kubebuilder:rbac:groups=cache.homelab.io,resources=memcacheds,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=cache.homelab.io,resources=memcacheds/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=cache.homelab.io,resources=memcacheds/finalizers,verbs=update
